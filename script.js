    ...
    if (!reviews || reviews.length === 0) {
        reviewsList.innerHTML = `
            <div class="empty-reviews">
                ...
                <p>Your feedback helps other patients make informed decisions. Share your experience with Dr. Prathyusha and help build our community.</p>
                <div class="empty-reviews-stars">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (reviewForm) {
        reviewForm.addEventListener('submit', async function(e) {
            ...
            const review = document.getElementById('reviewerText').value.trim();
            if (!name || !rating || !review) {
                showNotification('Please fill in all fields for your review.', 'error');
                return;
            }
            try {
                const res = await fetch('/api/reviews', {
